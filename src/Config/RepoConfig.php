...
final readonly class RepoConfig {
   ...
   * @param \AlexSkrypnyk\SkillTest\Config\DockerConfig $docker
   *   The `llm.docker` block: the image and per-container limits for the docker
   *   environment.
  ...
  public static function fromArray(array $data): self {
    ...
    return new self(
      ...
      DockerConfig::fromArray(Data::toArray(Data::get($data, 'llm', 'docker'))),
