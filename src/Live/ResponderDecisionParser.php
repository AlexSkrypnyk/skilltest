 ...
 * a model wraps JSON in prose or fences like any other, so parsing is
 * hardened: the first balanced object is extracted, the `action` is matched
 * case-insensitively against the three legitimate moves, and a reply must
 * carry a non-empty message to be usable. Anything
