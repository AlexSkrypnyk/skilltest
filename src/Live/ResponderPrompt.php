 ...
 * hands it the persona brief it must stay consistent with, and shows the dialogue
 * so far so its answer follows from the whole exchange rather than the last line
 * alone. It ends with the exact JSON shape the decision parser expects and the
 * three legitimate moves - reply, stop, abstain - so the responder answers,
 * recognises when the agent is done, or abstains rather than inventing an answer
