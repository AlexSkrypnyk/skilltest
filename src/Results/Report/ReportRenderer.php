 ...
 *
 * The matrix grid, minimal-model verdict, and cost totals print only when
 * the run carried llm results. Every number is read through `Metrics`, so
 * the summary matches what the run recorded.
 */
